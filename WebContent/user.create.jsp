						...
						<div class="box-body">
							<c:if test="${isError}">
								<div class="alert alert-danger alert-dismissible">
									...
									<c:choose>
										<c:when test="${isFailed}">Có lỗi khi tạo tài khoản mới.</c:when>
							...
							<div class="row">
								<div class="col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="request_username" name="username" required value="<c:out value="${targetUsername}" />">
									</div>
								</div>
								<div class="col-sm-6 col-xs-12">
									<div class="form-group">
										<label class="required" for="request_password">Mật khẩu</label>
										<input type="text" class="form-control" id="request_password" name="password" required>
									</div>
								</div>
							</div>
						</div>
